        ...
        <div className="space-y-16 border-l-2 border-black/10 dark:border-white/10 pl-6 md:pl-10">
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
              By accessing or using DevsDistro ("Platform"), you agree to be bound by these Terms of Service.
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg mb-8">
              To use the Platform, you are required to authenticate via GitHub OAuth and authorize the official DevsDistro GitHub App.
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg mb-6">
              ...
              You define the valuation of your codebase in USD fiat. At the time of execution, DevsDistro automatically converts this amount and processes the transaction exclusively in native SOL on the Solana blockchain through a connected Web3 wallet (e.g., Phantom, Solflare).
            </p>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
              <strong className="text-black dark:text-white uppercase text-sm tracking-widest font-syne mr-2">Automated Delivery /</strong>
              When you list a repository, we immediately pull the latest commit and compile it into a secure ZIP file stored in our AWS S3 infrastructure. Upon on-chain confirmation of payment, this pre-packaged archive is served directly to the buyer for immediate download. DevsDistro facilitates the pipeline but relies on the immutability of the blockchain for settlement.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg mb-6">
              ...
              DevsDistro makes reasonable efforts to maintain the integrity, security, and reliability of the Platform. However, all software may contain defects, bugs, or vulnerabilities. To the maximum extent permitted by applicable law, DevsDistro shall not be held responsible or liable for any loss of funds, digital assets, cryptocurrency, or financial damages of any nature arising from software errors, bugs, platform malfunctions, failed transactions, incorrect price calculations, or any other technical deficiency — whether or not such deficiency was known or foreseeable by DevsDistro at the time of the incident.
            </p>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
              By using the Platform and initiating any financial transaction, you expressly acknowledge and accept that all transactions are executed at your own risk. You are solely responsible for independently verifying transaction details — including recipient addresses and SOL amounts — prior to authorizing any payment through your connected Web3 wallet. DevsDistro strongly recommends transacting only amounts you are prepared to lose in the event of an unforeseen technical failure.
            </p>
          </section>

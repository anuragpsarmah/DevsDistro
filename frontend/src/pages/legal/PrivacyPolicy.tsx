        ...
        <div className="space-y-16 border-l-2 border-black/10 dark:border-white/10 pl-6 md:pl-10">
          <section>
            ...
            <ul className="space-y-4 text-gray-600 dark:text-gray-400 text-lg">
              ...
              <li className="flex gap-4">
                <span className="text-red-500 font-bold opacity-50">/</span>
                <span><strong className="text-black dark:text-white uppercase text-sm tracking-widest font-syne mr-2">Repository Metadata -</strong> We fetch listed repository metadata (names, descriptions, stack, statistics) to display your listings on the DevsDistro marketplace.</span>
              </li>
              <li className="flex gap-4">
                <span className="text-red-500 font-bold opacity-50">/</span>
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg mb-8">
              DevsDistro treats your intellectual property with the highest security standards. We have deliberately shifted away from storing long-lived personal access tokens in favor of robust App-level sandboxing:
            </p>
            <ul className="space-y-4 text-gray-600 dark:text-gray-400 text-lg">
              <li className="flex gap-4">
                <span className="text-red-500 font-bold opacity-50">/</span>
                <span><strong className="text-black dark:text-white uppercase text-sm tracking-widest font-syne mr-2">GitHub App Integration -</strong> You authorize the DevsDistro GitHub App exclusively for the repositories you choose to list. We do not have read or write access to your entire GitHub account. Authentication is handled via short-lived, automated JWTs defined directly by GitHub's OAuth APIs.</span>
              </li>
              <li className="flex gap-4">
                <span className="text-red-500 font-bold opacity-50">/</span>
          ...
          <section>
            ...
            <ul className="space-y-4 text-gray-600 dark:text-gray-400 text-lg pb-12">
              ...
              <li className="flex gap-4">
                <span className="text-red-500 font-bold opacity-50">/</span>
                Purge your account and associated webhook subscriptions from DevsDistro servers.
              </li>
            </ul>
          </section>
        </div>

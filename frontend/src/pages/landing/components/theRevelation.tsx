        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          >
            <div className="grid grid-cols-2 gap-px bg-gray-200 dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-800 transition-colors">
              <div className="bg-gray-50 dark:bg-[#0a0a0a] p-8 aspect-square flex flex-col justify-between group hover:bg-black dark:hover:bg-white transition-colors duration-300">
                <span className="font-space text-gray-500 text-sm group-hover:text-gray-400">
                  01
                </span>
                <div>
                  <h3 className="font-syne text-2xl font-bold text-black dark:text-white group-hover:text-white dark:group-hover:text-black mb-2 uppercase transition-colors">
                    Connect
                  </h3>
                  <p className="font-space text-sm text-gray-500 dark:text-gray-400 group-hover:text-gray-300 dark:group-hover:text-gray-600 transition-colors">
                    Link your GitHub repository in seconds. Fluid, painless
                    onboarding.
                  </p>
                </div>
              </div>
              <div className="bg-gray-50 dark:bg-[#0a0a0a] p-8 aspect-square flex flex-col justify-between group hover:bg-black dark:hover:bg-white transition-colors duration-300">
                ...
                <div>
                  ...
                  <p className="font-space text-sm text-gray-500 dark:text-gray-400 group-hover:text-gray-300 dark:group-hover:text-gray-600 transition-colors">
                    Set your desired value in USD. Get paid exclusively in SOL.
                  </p>
                </div>
              </div>
              <div className="bg-gray-50 dark:bg-[#0a0a0a] p-8 aspect-square flex flex-col justify-between group hover:bg-black dark:hover:bg-white transition-colors duration-300">
                ...
                <div>
                  ...
                  <p className="font-space text-sm text-gray-500 dark:text-gray-400 group-hover:text-gray-300 dark:group-hover:text-gray-600 transition-colors">
                    Buyers instantly receive a complete, downloadable ZIP
              ...
              <div className="bg-red-500 p-8 aspect-square flex flex-col justify-between group hover:bg-black dark:hover:bg-white transition-colors duration-300">
                <span className="font-space text-white/70 text-sm group-hover:text-gray-400">
                  04
                </span>
                <div>
                  <h3 className="font-syne text-2xl font-bold text-white dark:text-black group-hover:text-white dark:group-hover:text-black mb-2 uppercase transition-colors">
                    Earn
                  </h3>
                  <p className="font-space text-sm text-white/90 dark:text-black/80 group-hover:text-gray-300 dark:group-hover:text-gray-600 transition-colors">
                    We take a 1% platform fee. You retain 99% of the value from
          ...
          >
            ...
            <div className="space-y-6 font-space text-gray-600 dark:text-gray-400 text-lg transition-colors">
              <p>
                DevsDistro connects you with a global audience of developers and
                builders through frictionless Solana settlements.
              </p>
              <p className="border-l-2 border-red-500 pl-4 text-black dark:text-white transition-colors">
                You price it in fiat. They pay via Web3 wallets. We handle the
                conversion and the secure ZIP delivery in milliseconds.
              </p>
            </div>
          </motion.div>
        </div>

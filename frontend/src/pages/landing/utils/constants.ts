...
export const faqs: FAQItem[] = [
  {
    question: "How does DevsDistro work?",
    answer:
      "DevsDistro is a marketplace platform where developers can showcase, sell, and collaborate on GitHub repositories. You can either explore existing repositories to purchase or list your own repositories directly from GitHub.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "DevsDistro uses Solana-based payments. Buyers complete transactions using their Solana wallets, and funds are transferred directly to the seller's wallet. Once the payment is confirmed on-chain, buyers get immediate access to the purchased project.",
  },
  {

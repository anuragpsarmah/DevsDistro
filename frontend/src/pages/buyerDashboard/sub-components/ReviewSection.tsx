...
export default function ReviewSection({
  ...
  return (
    <div className="border-2 border-neutral-800 dark:border-white bg-white dark:bg-[#050505] p-8 lg:p-12 mb-12 shadow-[8px_8px_0_0_rgba(38,38,38,1)] dark:shadow-[8px_8px_0_0_rgba(255,255,255,1)]">
      {/* Section Header */}
        ...
        <div className="mb-8">
          ...
          {!isEditing && !myReview && !isMyReviewLoading && canWriteReview && (
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-5 border-2 border-dashed border-neutral-800/30 dark:border-white/30 hover:border-neutral-800 dark:hover:border-white font-space font-bold uppercase tracking-widest text-xs text-gray-500 dark:text-gray-400 hover:text-neutral-800 dark:hover:text-white transition-all"
            >
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3 mt-3">
                {canEditOwnReview && (
                  <button
                    onClick={handleStartEdit}
                    className="flex items-center gap-2 px-4 py-2 border-2 border-neutral-800 dark:border-white font-space font-bold uppercase tracking-widest text-[10px] hover:bg-neutral-800 hover:text-white dark:hover:bg-white dark:hover:text-neutral-800 transition-colors"
                  >
                ...
                {canDeleteOwnReview && confirmDelete ? (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      disabled={deleteMutation.isPending}
                      className="px-4 py-2 border-2 border-neutral-800/30 dark:border-white/30 text-neutral-800/50 dark:text-white/50 font-space font-bold uppercase tracking-widest text-[10px] hover:border-neutral-800 dark:hover:border-white hover:text-neutral-800 dark:hover:text-white transition-colors disabled:opacity-50"
                    >
                      Cancel
                    </button>
                  </div>
          ...
          {isEditing && canEditOwnReview && (
            <div className="border-2 border-neutral-800 dark:border-white p-6 mb-6 bg-gray-50 dark:bg-[#0a0a0a]">
              ...
              <div className="space-y-5">
                <div>
                  <label className="font-space font-bold uppercase tracking-widest text-xs text-neutral-800 dark:text-white mb-3 block">
                ...
                <div>
                  <label className="font-space font-bold uppercase tracking-widest text-xs text-neutral-800 dark:text-white mb-2 block">
                    Review{" "}
                  ...
                  <textarea
                    ...
                    className="w-full border-2 border-neutral-800 dark:border-white bg-white dark:bg-[#050505] text-neutral-800 dark:text-white font-space text-sm p-4 resize-none focus:outline-none focus:border-red-500 transition-colors disabled:opacity-50 placeholder:text-gray-400 dark:placeholder:text-gray-600"
                  />
                  <p
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-neutral-800 dark:bg-white text-white dark:text-neutral-800 border-2 border-neutral-800 dark:border-white font-space font-bold uppercase tracking-widest text-xs hover:bg-red-500 hover:border-red-500 dark:hover:bg-red-500 dark:hover:border-red-500 hover:text-white dark:hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSavingReview && (
                      <Loader2 className="w-3 h-3 animate-spin" />
                    )}
                  ...
                  <button
                    ...
                    disabled={isSavingReview}
                    className="px-6 py-3 border-2 border-neutral-800/30 dark:border-white/30 text-neutral-800/50 dark:text-white/50 font-space font-bold uppercase tracking-widest text-xs hover:border-neutral-800 dark:hover:border-white hover:text-neutral-800 dark:hover:text-white transition-colors disabled:opacity-50"
                  >
                    Cancel
                  </button>
                </div>
      ...
      {!isLoading && reviews.length > 0 && (
        <div className="space-y-4 relative">
          {isListFetching && (
            <div className="absolute inset-0 bg-white/60 dark:bg-neutral-800/60 flex items-center justify-center z-10 rounded-sm">
      ...
      {pagination?.hasNextPage && (
        <button
          ...
          className="mt-6 w-full flex items-center justify-center gap-2 py-4 border-2 border-neutral-800 dark:border-white font-space font-bold uppercase tracking-widest text-xs hover:bg-neutral-800 hover:text-white dark:hover:bg-white dark:hover:text-neutral-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >

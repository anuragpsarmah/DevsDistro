    ...
    <TransitionWrapper identifier="marketplace-list" isTransitioning={false}>
      <div className="space-y-6 mt-6 lg:mt-0 md:mt-0 flex flex-col min-h-[calc(100vh-4rem)]">
        ...
        {isError && !isInitialLoading && (
          <div className="flex flex-col items-center justify-center py-20 space-y-6 border-2 border-neutral-800 dark:border-white bg-white dark:bg-[#050505] shadow-[8px_8px_0_0_rgba(38,38,38,1)] dark:shadow-[8px_8px_0_0_rgba(255,255,255,1)] p-8 my-8">
        ...
        {!isInitialLoading && !isError && !hasResults && (
          <div className="flex-1 p-4 lg:p-6 flex flex-col items-center justify-center">
            <div className="w-full max-w-2xl border-2 border-neutral-800 dark:border-white bg-white dark:bg-[#050505] p-8 lg:p-12 relative overflow-hidden flex flex-col items-center justify-center text-center transition-colors duration-300 mx-auto mt-12 mb-12">
              <div className="mb-8">

    ...
    <div className="flex flex-col md:flex-row gap-12 lg:gap-16">
      <div className="flex flex-col flex-1 space-y-8">
        <div className="flex items-center space-x-4 pb-4 border-b-2 border-neutral-800 dark:border-white transition-colors duration-300">
          <div
            className={`p-2 border-2 ${hasMismatchCondition ? "border-red-500 bg-red-500/10" : "border-neutral-800 dark:border-white bg-neutral-800 dark:bg-white"}`}
          >
            <Wallet
              className={`h-6 w-6 ${hasMismatchCondition ? "text-red-500 animate-[pulse_1s_steps(2,start)_infinite]" : "text-white dark:text-neutral-800"}`}
            />
          </div>
            ...
            <div
              className={`p-8 border-2 bg-white dark:bg-[#050505] transition-all duration-300 ${
                hasMismatchCondition
                  ...
                  : "border-neutral-800 dark:border-white group-hover:bg-neutral-800 dark:group-hover:bg-white group-hover:shadow-[4px_4px_0px_0px_rgba(38,38,38,1)] dark:group-hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]"
            ...
            >
              <SolanaLogo
                className={`h-16 w-16 transition-colors duration-300 ${
                  hasMismatchCondition
                    ? "text-red-500"
                    : "text-neutral-800 dark:text-white group-hover:text-white dark:group-hover:text-neutral-800"
                }`}
              />
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="space-y-8">
          <div className="bg-transparent border-2 border-neutral-800 dark:border-white p-6 transition-colors duration-300">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between mt-2">
                <span className="text-lg text-neutral-800 dark:text-white font-space font-bold tracking-wider">
                ...
                <div className="flex space-x-2">
                  <Button
                    ...
                    className="h-10 w-10 rounded-none border-2 border-neutral-800 dark:border-white text-neutral-800 dark:text-white hover:bg-neutral-800 dark:hover:bg-white hover:text-white dark:hover:text-neutral-800 transition-all duration-300"
          ...
          <Button
            type="button"
            className="w-full h-14 bg-red-500 text-white border-2 border-transparent hover:border-neutral-800 dark:hover:border-white rounded-none transition-all duration-300 flex items-center justify-center gap-3 group font-space uppercase tracking-widest font-bold text-sm hover:bg-red-600"

  ...
  <div className="space-y-8 p-6 lg:p-10 border-2 border-neutral-800/10 dark:border-white/10">
    <div>
      ...
      <Textarea
        ...
        className="bg-transparent border-2 border-neutral-800/20 dark:border-white/20 text-neutral-800 dark:text-white hover:border-neutral-800 dark:hover:border-white focus:border-red-500 focus:ring-0 rounded-none transition-colors duration-300 p-4 font-space h-40 resize-none placeholder:text-neutral-800/30 placeholder:dark:text-white/30"
      />
    ...
    <div className="border-t-2 border-neutral-800/10 dark:border-white/10 pt-8 mt-2">
      <Label className="font-space font-bold uppercase tracking-[0.2em] text-[10px] md:text-xs text-neutral-800/50 dark:text-white/50 mb-4 block">
        DevsDistro Rating
      </Label>
          ...
          <Star
            ...
            className={`w-10 h-10 cursor-pointer transition-colors duration-300 ${
              star <= rating
                ...
                : "text-neutral-800/20 dark:text-white/20 hover:text-neutral-800/40 hover:dark:text-white/40"
            }`}
            strokeWidth={1.5}

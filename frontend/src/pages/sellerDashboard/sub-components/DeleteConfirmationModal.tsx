...
> = ({
  ...
  return (
    ...
    >
      <AlertDialogContent className="bg-white dark:bg-[#050505] p-8 border-2 border-neutral-800 dark:border-white shadow-[8px_8px_0px_0px_rgba(38,38,38,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] w-full max-w-lg mx-auto rounded-none overflow-hidden transition-colors duration-300">
        <AlertDialogHeader className="relative z-10 m-0 p-0">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-12 h-12 border-2 border-neutral-800 dark:border-white flex items-center justify-center transition-colors duration-300 shrink-0 bg-transparent">
              <Trash2 className="w-6 h-6 text-red-500" />
            </div>
            <div className="text-left">
              <AlertDialogTitle className="font-syne text-xl font-bold uppercase tracking-wider text-neutral-800 dark:text-white transition-colors duration-300 text-left">
                Confirm Deletion
              </AlertDialogTitle>
            </div>
          </div>

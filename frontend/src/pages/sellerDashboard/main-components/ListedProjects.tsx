  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="space-y-6 lg:space-y-8 pb-10">
        {showWalletConnectionNotice && (
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 lg:p-5 border-2 border-red-500 bg-red-500/5 transition-colors duration-300">
            <div className="flex items-start gap-3">
              <Wallet className="h-5 w-5 text-red-500 flex-shrink-0 mt-0.5" />
              <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-3 gap-6 lg:gap-8">
